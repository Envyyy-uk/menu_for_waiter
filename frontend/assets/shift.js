/* ==========================================================================
   ...
   ни одного нажатия. Поэтому PIN вводят дважды за вечер: когда смену
   открывают и когда закрывают.

   PIN подходит любой из двух: свой личный (тогда в смене останется имя — за
   вечер барменов бывает двое) или общий PIN станции, если свой забыли.
...
const Shift = {
  ...
  gate() {
    this.ask('Смена не открыта', this.state.configured
      ...
      : 'Введите свой PIN. Общий PIN станции задаётся в админке',
      async pin => {
