        ...
        out.append(
            {
                ...
                "opened_by": opened_by,
                "closed_by": closed_by,
                # Все, кто стоял на этой станции за смену, — каждый со
                # своими часами. Один отработает три, другой семь, и длина
                # смены о зарплате не говорит ничего.
                "people": shift_service.people_detail(db, s),
            }
        )
    return out
